# 🏈 Simple Python Football Drive (Kid-Friendly)
# Save this file as football_game.py and run:  python3 football_game.py
...
def main():
    ...
    say("\nThanks for playing! Run this again to see a different drive.")
